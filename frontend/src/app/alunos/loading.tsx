    ...
    <SidebarProvider>
      ...
      <div className="flex min-h-screen flex-1 flex-col bg-[#000000]">
        <header className="sticky top-0 z-10 flex items-center justify-between border-b border-[#FFFFFF]/10 bg-[#020203]/90 px-4 py-3 backdrop-blur sm:px-6 sm:py-4">
          <Skeleton className="h-8 w-32 bg-[#FFFFFF]/10" />
          <Skeleton className="h-8 w-24 bg-[#FFFFFF]/10" />
        </header>
        ...
        <main className="flex-1 space-y-5 p-4 sm:space-y-6 sm:p-6">
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <Card key={i} className="border-[#FFFFFF]/12 bg-[#020203]">
                <CardHeader className="px-4 pb-2 pt-4 sm:px-5">
                  <Skeleton className="h-3 w-24 bg-[#FFFFFF]/10" />
                </CardHeader>
                <CardContent className="px-4 pb-4 sm:px-5">
                  <Skeleton className="h-7 w-16 bg-[#FFFFFF]/10" />
          ...
          <Card className="border-[#FFFFFF]/12 bg-[#020203]">
            <CardHeader className="px-4 pb-3 pt-5 sm:px-5">
              <Skeleton className="h-4 w-32 bg-[#FFFFFF]/10" />
              <Skeleton className="mt-1.5 h-3 w-56 bg-[#FFFFFF]/8" />
            </CardHeader>
              ...
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="flex items-center gap-4 py-2">
                  <div className="flex-1 space-y-1.5">
                    ...
                    <Skeleton className="h-3 w-24 bg-[#FFFFFF]/8" />
                  </div>
                  <Skeleton className="hidden h-3 w-28 bg-[#FFFFFF]/8 md:block" />
                  <Skeleton className="hidden h-3 w-16 bg-[#FFFFFF]/8 sm:block" />
                  <Skeleton className="h-5 w-14 rounded-full bg-[#FFFFFF]/10" />
                  <Skeleton className="h-7 w-16 bg-[#FFFFFF]/8" />
                </div>
              ))}
            </CardContent>
          </Card>
